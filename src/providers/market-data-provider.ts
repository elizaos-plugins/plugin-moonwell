...
export const marketDataProvider: Provider = {
  ...
  description:
    "Provides current Moonwell market conditions and rates for lending/borrowing decisions",
  ...
  get: async (
    ...
    try {
      ...
      marketData.sort((a, b) => {
        const comparison = b.totalSupply
          .plus(b.totalBorrow)
          .comparedTo(a.totalSupply.plus(a.totalBorrow));
        return comparison || 0;
      });
